                                                                  ...
                                                                  child: Container(
                                                                    ...
                                                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                      Container(
                                                                        width: double.infinity,
                                                                        child: TextFormField(
                                                                          onChanged: (input) => _con.registerData.name = input,
                                      ...
                                      child:  TextButton(
                                          onPressed: () {
                                            if(_tabController.index==0){
                                              if(_con.registerData.name.trim().isEmpty) {
                                                  ScaffoldMessenger.of(context)
                                                      .showSnackBar(SnackBar(content: Text("Please Enter Your Name")));
                                                }
                                              else if(_con.registerData.emailId.trim().isEmpty){
                                                ScaffoldMessenger.of(context)
                                                    .showSnackBar(SnackBar(content: Text("Please Enter Your email")));
                                              }
                                              else if(_con.registerData.password.trim().isEmpty){
                                                ScaffoldMessenger.of(context)
                                                    .showSnackBar(SnackBar(content: Text("Please Enter Your password")));
                                              }
                                              else if(_con.registerData.phone.trim().isEmpty){
                                                ScaffoldMessenger.of(context)
                                          ...
                                          child: Wrap(children: [
                                            ...
                                            Container(
                                                padding: EdgeInsets.only(top: 3, left: 10, right: 5),
                                                child: Text(_tabController.index == 4 ? S.of(context).done : S.of(context).next,
                                                    textAlign: TextAlign.center,
                                                    style: TextStyle(
                                                        fontFamily: 'Touche W03 Regular',
                                                        fontWeight: FontWeight.w100,
