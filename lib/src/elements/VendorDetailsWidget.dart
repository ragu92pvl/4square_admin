...
import 'package:login_and_signup_web/src/elements/VendorSettlementListWidget.dart';
...
import 'VendorSettlementCompletedListWidget.dart';
...
class _VendorDetailsWidgetState extends StateMVC<VendorDetailsWidget>
  ...
  Widget build(BuildContext context) {
   var size = MediaQuery.of(context).size;
    ...
    return widget.con.profileDetails.bankDetails.personalProof!=null?AppCard(
                                ...
                                Div(
                                  ...
                                  child:Padding(
                                    ...
                                    child: Container(
                                        ...
                                        child: Text('Ifsc Code',style: Theme.of(context).textTheme.bodyText1,)),
                                  ),
                                ),
                                Div(
                                  colS:8,
                                  ...
                                  child:Padding(
                                    ...
                                    child: Container(
                                        ...
                                        child: Text(widget.con.profileDetails.bankDetails.bankCode,style: Theme.of(context).textTheme.subtitle2,)),
                                  ),
                                ),
                                Div(
                                  colS:4,
                        ...
                        child:Scaffold(
                          appBar:AppBar(
                            ...
                            bottom:TabBar(
                                ...
                                tabs:[
                                  Tab(
                                      child:Text(S.of(context).order,style: TextStyle(color: Colors.black),)
                                  ),
                                  Tab(
                                      child:Text("Pending Settlement",style: TextStyle(color: Colors.black),)
                                  ),
                                  Tab(
                                      child:Text("Completed Settlement",style: TextStyle(color: Colors.black),)
                                  )
                                ]
                            ),
                          ),
                                  ...
                                  child:SingleChildScrollView(
                                    child: Column(
                                      children: [
                                        ...
                                        // ),
                                        //WalletTransactionListWidget(type: 'vendor',vendorId: int.parse(widget.con.profileDetails.general.id),),
                                        VendorSettlementCompletedListWidget(
                                          type: 'vendor',
                                          vendorId: widget.shopId,
                                        ),
                                      ],
