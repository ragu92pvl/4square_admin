...
class _ShopTypeBoxWidgetState extends StateMVC<ShopTypeBoxWidget> {
  ...
  _ShopTypeBoxWidgetState() : super(ProductController()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    super.initState();
    if(widget.shopTypeData.isStatus == "1"){
      isSwitched = true;
    }else{
      isSwitched = false;
    }
        ...
        child:  Container(
          ...
          child:Column(
              children:[
                  ...
                  children: [
                    ...
                    Switch(
                      ...
                      onChanged: (newValue) {
                        setState(() {
                          isSwitched = newValue;
                          _con.shopTypeChange(widget.shopTypeData.id,isSwitched);
                        });
                      },
                    ),
                  ],
                ...
                SizedBox(height: 20),
                Text('Status ${isSwitched ? 'on' : 'off'}',style: TextStyle(color: Colors.white),),
              ]
          ),
        ),
      ),
