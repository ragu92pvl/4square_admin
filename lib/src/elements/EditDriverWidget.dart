...
import '../models/driverregistermodel.dart';
...
class EditDriverWidget extends StatefulWidget {
  ...
  DriverRegistermodel driverData;
   ...
   EditDriverWidget({Key key, this.con,this.setState,this.driverData,this.pageType});

  @override
  _EditDriverWidgetState createState() => _EditDriverWidgetState();
}

class _EditDriverWidgetState extends StateMVC<EditDriverWidget> {
  ...
  _EditDriverWidgetState() : super(PrimaryUserController()) {
    _con = controller;
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  /*                              Container(
                                            ...
                                            _con.registerData.isPasswordChange ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                                              Container(
                                                  width: double.infinity,
                                                  height: 70,
                                                  child: TextFormField(
                                         ...
                                         /*   Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                                            ...
                                            Row(
                                              children: [
                                                Checkbox(
                                                  value: _con.registerData.isPasswordChange,
                                                  onChanged: (newValue) {
                                                    setState(() {
                                                      _con.registerData.isPasswordChange = newValue;
                                                    });
                                                  },
                                                ),
      ...
      setState(() {
        if (pickedFile != null) {
          ...
          if (GetPlatform.isMobile) {
            widget.con.registerData.image = _image;
          } else if (GetPlatform.isWeb) {
            widget.con.registerData.image  = pickedFile;
          }
