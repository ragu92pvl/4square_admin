...
class GeneralSettingsTabWidget extends StatefulWidget {
  ...
  UserController con;
  @override
  _GeneralSettingsTabWidgetState createState() =>
      _GeneralSettingsTabWidgetState();
}
...
class _GeneralSettingsTabWidgetState extends StateMVC<GeneralSettingsTabWidget>
  ...
  void initState() {
    ...
    widget.con.adminPayment.currencyPosition =
        widget.con.settingDetails.payment.currencyPosition;
    widget.con.adminGeneral.defaultLang =
        widget.con.settingDetails.general.defaultLang;
    widget.con.adminGeneral.timeZone =
        widget.con.settingDetails.general.timeZone;
    widget.con.delivery.instantDelivery =
        widget.con.settingDetails.delivery.instantDelivery;
    widget.con.delivery.autoassing =
        widget.con.settingDetails.delivery.autoassing;
    widget.con.delivery.deliveryTips =
        widget.con.settingDetails.delivery.deliveryTips;
    setState(() {
      distancetype = widget.con.settingDetails.delivery.deliverType;
      widget.con.adminPayment.currency =
          widget.con.settingDetails.payment.currency;
    });
  }
          ...
          SizedBox(
            ...
            child: TabBarView(
              ...
              children: [
                Container(
                    child: Form(
                  key: widget.con.adminGeneralFormKey,
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        initialValue: widget.con.settingDetails
                                            .general.systemName,
                                        onSaved: (input) => widget.con
                                            .adminGeneral.systemName = input,
                                        validator: (input) => input.length < 1
                                            ? S
                                                .of(context)
                                                .please_enter_system_name
                                            : null,
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        onSaved: (input) => widget
                                            .con.adminGeneral.email = input,
                                        initialValue: widget
                                            .con.settingDetails.general.email,
                                        decoration: InputDecoration(
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        validator: (input) => input.length < 1
                                            ? S
                                                .of(context)
                                                .please_enter_system_title
                                            : null,
                                        onSaved: (input) => widget.con
                                            .adminGeneral.systemTitle = input,
                                        initialValue: widget.con.settingDetails
                                            .general.systemTitle,
                                        decoration: InputDecoration(
                                          labelText: S
                                              .of(context)
                                              .context_system_title,
                                          labelStyle: Theme.of(context)
                                              .textTheme
                                              .bodyText2
                                              .merge(TextStyle(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        keyboardType: TextInputType.text,
                                        validator: (input) => input.length < 1
                                            ? S.of(context).please_enter_api
                                            : null,
                                        onSaved: (input) =>
                                            widget.con.adminGeneral.api = input,
                                        initialValue: widget
                                            .con.settingDetails.general.api,
                                        decoration: InputDecoration(
                                          labelText:
                                              S.of(context).google_map_api,
                                          labelStyle: Theme.of(context)
                                              .textTheme
                                              .bodyText2
                                              .merge(TextStyle(
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        validator: (input) => input.length < 1
                                            ...
                                            : null,
                                        onSaved: (input) => widget.con
                                            .adminGeneral.countryCode = input,
                                        initialValue: widget.con.settingDetails
                                            .general.countryCode,
                                        decoration: InputDecoration(
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        validator: (input) => input.length < 1
                                            ...
                                            : null,
                                        onSaved: (input) => widget
                                            .con.adminGeneral.dialCode = input,
                                        initialValue: widget.con.settingDetails
                                            .general.dialCode,
                                        decoration: InputDecoration(
                                          labelText: 'Dial Code',
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        validator: (input) => input.length < 1
                                            ...
                                            : null,
                                        onSaved: (input) => widget
                                            .con.adminGeneral.phone = input,
                                        inputFormatters: <TextInputFormatter>[
                                          FilteringTextInputFormatter.digitsOnly
                                        ],
                                        initialValue: widget
                                            .con.settingDetails.general.phone,
                                        decoration: InputDecoration(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        initialValue: widget.con.settingDetails
                                            .general.customerSupport,
                                        decoration: InputDecoration(
                                          labelText:
                                              'Customer Support (Whatsapp chat )',
                                          labelStyle: Theme.of(context)
                                              .textTheme
                                              .bodyText2
                                              .merge(TextStyle(
                                    ...
                                    children: [
                                      ...
                                      DropdownButton(
                                          ...
                                          items: languagesList.languages
                                            ...
                                            return new DropdownMenuItem(
                                              value: map.localName,
                                              child: new Text(map.englishName,
                                                  style: new TextStyle(
                                                      color: Colors.black)),
                                            );
                                          }).toList(),
                                          onChanged: (value) {
                                            ...
                                            widget.con.adminGeneral
                                                .defaultLang = code;

                                            if (_lang.length > 1)
                                              setting.value.mobileLanguage
                                                      .value =
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      maxLines: 5,
                                      validator: (input) => input.length < 1
                                          ? S.of(context).please_enter_addres
                                          : null,
                                      onSaved: (input) => widget
                                          .con.adminGeneral.address = input,
                                      initialValue: widget
                                          .con.settingDetails.general.address,
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      onSaved: (input) => widget
                                          .con.adminGeneral.description = input,
                                      initialValue: widget.con.settingDetails
                                          .general.description,
                                      maxLines: 5,
                                      decoration: InputDecoration.collapsed(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: DropdownButton(
                                            value: widget.con.settingDetails
                                                .payment.currency,
                                            isExpanded: true,
                                            focusColor: Theme.of(context)
                                                .colorScheme
                                            ...
                                            onChanged: (value) {
                                              setState(() {
                                                widget.con.settingDetails
                                                    .payment.currency = value;
                                                widget.con.adminPayment
                                                    .currency = value;
                                              });
                                            }),
                                      ),
                                        ...
                                        child: Wrap(
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(S
                                                  .of(context)
                                                  .show_currency_in_the_right_of_price),
                                            ),
                                            SizedBox(width: 10),
                                            Container(
                                              width: 65,
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        onSaved: (input) => widget
                                            .con
                                            .adminPayment
                                            .minimumPurchase = input,
                                        initialValue: widget.con.settingDetails
                                            .payment.minimumPurchase,
                                        decoration: InputDecoration(
                                          labelText:
                                              S.of(context).minimum_purchase,
                                          labelStyle: Theme.of(context)
                                              .textTheme
                                              .bodyText2
                                              .merge(TextStyle(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        onSaved: (input) => widget.con
                                            .adminPayment.decimalPoints = input,
                                        initialValue: widget.con.settingDetails
                                            .payment.decimalPoints,
                                        decoration: InputDecoration(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                    ...
                                    child: TextFormField(
                                        ...
                                        onSaved: (input) => widget.con
                                            .adminPayment.cancelTimer = input,
                                        initialValue: widget.con.settingDetails
                                            .payment.cancelTimer,
                                        decoration: InputDecoration(
                                          labelText: S
                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          ...
                                          validator: (input) => input.length < 1
                                              ...
                                              : null,
                                          onSaved: (input) =>
                                              widget.con.smtp.port = input,
                                          initialValue: widget
                                              .con.settingDetails.smtp.port,
                                          decoration: InputDecoration(
                                            labelText: 'Smtp Port',
                                            labelStyle: Theme.of(context)
                                                .textTheme
                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          ...
                                          validator: (input) => input.length < 1
                                              ...
                                              : null,
                                          onSaved: (input) =>
                                              widget.con.smtp.password = input,
                                          initialValue: widget
                                              .con.settingDetails.smtp.password,
                                          obscureText: true,
                                          decoration: InputDecoration(
                ...
                Container(
                  child: Form(
                    key: widget.con.deliveryFormKey,
                    child: SingleChildScrollView(
                        child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                                    ...
                                    children: [
                                      ...
                                      DropdownButtonFormField(
                                          ...
                                          onChanged: (value) {
                                            ...
                                            widget.con.delivery.deliverType =
                                                distancetype;
                                          }),
                                    ],
                                  ),
