...
import 'package:login_and_signup_web/src/elements/EditVendorWidget.dart';
                          ...
                          child:Wrap(
                              children:[
                                Div(
                                 ...
                                 widget.details.profileStatus=='waiting'?Div(
                                  colS:4,
                                  colM:4,
                                  colL:4,
...
class EditVendorHelper {
  static exit(context) => showDialog(
      context: context,
      builder: (context) => StatefulBuilder(
          builder: (context, StateSetter setState) => EditVendorWidget(
          )));
}
