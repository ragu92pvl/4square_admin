...
class VendorSettlementListWidget extends StatefulWidget {

  String type;
  int vendorId;

  VendorSettlementListWidget({Key key,  this.type,this.vendorId}) : super(key: key);

  @override
  _VendorSettlementListWidgetState createState() => _VendorSettlementListWidgetState();
}

class _VendorSettlementListWidgetState extends StateMVC<VendorSettlementListWidget> {
  ...
  _VendorSettlementListWidgetState() : super(SecondaryController()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    super.initState();
    _con.listenForVendorSettlementList(widget.vendorId);
        ...
        sourceBuilder: (value, row) {
          ...
          return Container(
            ...
            child: InkWell(
              ...
              // showAlertDialog(context,row['fromdate'],row['lastdate'],widget.vendorId);
                showDialog(
                    context: context,
                    builder: (context) => AlertDialog(
                      ...
                      content: TextField(
                        ...
                        decoration: InputDecoration(hintText: "Enter transcation ID"),
                      ),
                      actions: <Widget>[
                        FlatButton(
                        ...
                        FlatButton(
                            onPressed: (){
                              _con.changeSettlement(row['fromdate'],row['lastdate'],widget.vendorId,_textFieldController.text.toString());
              ...
              child: Wrap(
                ...
                children: [
                  Badge(
                    ...
                    badgeContent: Text("Settlement", style: TextStyle(color: Colors.white)),
                  ),
                      ...
                      child: ResponsiveDatatable(
                        ...
                        onSort: (value) {
                          setState(() {
                            ...
                            if (_sortAscending) {
                              _con.settlementSource.sort((a, b) =>
  ...
  Widget showAlertDialog(BuildContext context,fromDate,lastDate,vendorId) {
