                                      ...
                                      Container(
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            //   content: Text('We are Working our Side'),
                                            //   backgroundColor: Colors.red,
                                            // ));
                                           AddEdPopupHelper.exit(context, _con, Coupon(), 'add');
                                          },
                                        ),
                                      )
                                    ]
            ...
            child: new Column(
              ...
              children: [
                ...
                new ListTile(
                  ...
                  onTap: () => {
                    Navigator.pop(context),
                    AddEdPopupHelper.exit(context,_con, couponDetails,'edit'),
                  },
                ),
                new ListTile(
...
class AddEdPopupHelper {
  ...
  static exit(context,con, details, pageType) => showDialog(context: context, builder: (context) =>  AECouponWidget(con: con,couponDetails: details, pageType: pageType, ));
}
