...
import 'package:login_and_signup_web/src/pages/searchbox_suncategory.dart';
...
class _SubCategoryPageState extends StateMVC<SubCategoryPage> {
  ...
  _SubCategoryPageState() : super(HServiceController()) {
    _con = controller;
  }
                              ...
                              child: Row(
                                  ...
                                  children:[
                                    Padding(
                                      ...
                                      child:IconButton(
                                        onPressed:(){
                                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => SearchBoxSubcategory(categoryList: _con.subcategoryList,)));
...
class _StoriesState extends StateMVC<Stories> {
  ...
  @override
  Widget build(BuildContext context) {
    return widget.con.subcategoryList.isEmpty? EmptyOrdersWidget()
        :Wrap(
        ...
        Imagepickerbottomsheet(widget.con.subcategoryList[index].id, widget.con.subcategoryList[index]);
        },
              child: SubCategoryBoxWidget(categoryData:widget.con.subcategoryList.elementAt(index)),
              ),
            ),
          );
        }
            ...
            child: new Column(
              ...
              children: [
                ...
                new ListTile(
                  ...
                  onTap: () => {
                    Navigator.pop(context),
                    AddSubCategoryHelper.exit(context,widget.con, categoryDetails,'edit'),
                  },
                ),
                new ListTile(
                  ...
                  onTap: () => {
                    widget.con.delete('h_sub_category',id),
                    Navigator.pop(context),
                    setState(() {
...
class AddSubCategoryHelper {
  ...
  static exit(context, con, categoryDetails, pageType) => showDialog(context: context, builder: (context) => StatefulBuilder(builder: (context, StateSetter setState) => AddSubCategoryPopup(con: con,categoryDetails: categoryDetails,pageType: pageType,setState:setState )));
}
