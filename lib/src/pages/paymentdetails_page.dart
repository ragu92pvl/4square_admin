                  ...
                  _con.bookingDetailsList.isEmpty?EmptyOrdersWidget():Container(
                    ...
                    child: CustomPaginatedTable(
                      ...
                      dataColumns: [
                        ...
                        DataColumn(
                          label: Text(S.of(context).service_amount),
                        ),

                        DataColumn(
                          label: Text(S.of(context).commission_amount),
                        ),
                        DataColumn(
                          label: Text(S.of(context).net_amount),
                        ),
                        DataColumn(
                          label: Text(S.of(context).payment_status),
                        ),
                        DataColumn(
                          label: Text(S.of(context).commission_status),
                        ),
                        DataColumn(
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: <DataCell>[
        ...
        DataCell(Text(_con.bookingDetailsList[index].settlementValue ?? '')),
        DataCell(Text(_con.bookingDetailsList[index].commissionAmount ?? '')),
        DataCell(Text(_con.bookingDetailsList[index].totalAmount ?? '')),
