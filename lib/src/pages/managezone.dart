                      ...
                      itemList.isEmpty?EmptyOrdersWidget():Container(
                        ...
                        child: CustomPaginatedTable(
                          ...
                          dataColumns: [
                            ...
                            DataColumn(
                              label: Text('Offline/Online'),
                            ),
                            DataColumn(label: Text(S.of(context).no_of_shops)),
                            DataColumn(label: Text(S.of(context).no_of_drivers)),
                            DataColumn(label: Text('no.of.providers')),
                            DataColumn(label: Text(S.of(context).options)),
                          ],
                          header:  Text('zones'),
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: <DataCell>[
        ...
        DataCell(Text(itemList[index].title??' ')),
        DataCell(Text(itemList[index].date??' ')),
        DataCell(Switch(
        ...
        DataCell(Text(itemList[index].shop.toString())),
        DataCell(Text(itemList[index].drivers.toString())),
        DataCell(Text(itemList[index].provider.toString())),
        DataCell(
            Row(
              children: [
                Container(
