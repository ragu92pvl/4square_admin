...
class _ProfileViewState extends StateMVC<ProfileView> {
  ...
  void initState() {
    ...
    _con.getVendorProfileDetailData(widget.shopId);
    _con.getProfileDetailData(widget.shopId);
    super.initState();
     ...
     child:SingleChildScrollView(
           ...
           child:Column(
             ...
             children:[
               ...
               Align(
                 ...
                 child:Padding(
                     ...
                     child:  Badge(
                       ...
                       badgeContent: Text(widget.status, style: TextStyle(color: Colors.white)),
                     ),
               ...
               InkWell(
                 onTap: (){
                   Navigator.of(context).push(MaterialPageRoute(builder: (context) => ProfileTweets(_con)));
                 },
                 child: Align(
                   alignment: Alignment.topRight,
                   child:Padding(
                     ...
                     child:  Badge(
                       ...
                       badgeColor: Colors.blue,
                       borderRadius: BorderRadius.circular(8),
                       badgeContent: Text("Edit", style: TextStyle(color: Colors.white)),
                     ),
