              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    Container(
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage("assets/img/loginbg2.jpg"),
                              fit: BoxFit.cover)),
                    ),
                    // Row(
                    ...
                    //       child: Image.asset('assets/img/resturentdefaultbg.jpg'),
                    //     ),
                    //     Container(
                    //       height: double.infinity,
                    //       child: Image.asset('assets/img/resturentdefaultbg.jpg'),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              S
                                  .of(context)
                                  .its_easy_and_take_less_than_30_seconds,
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 14,
                              ),
