...
//  String role;
  ...
  VendorUser.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      id = jsonMap['id'].toString();
      name = jsonMap['name'] != null ? jsonMap['name'] : '';
      general_detail = jsonMap['general_detail'] != null ? jsonMap['general_detail'] : '';
  ...
  Map toMap() {
    ...
    map["email"] = email;
    map["name"] = name;
    map["general_detail"] = general_detail;
    //map['auth'] = auth;
